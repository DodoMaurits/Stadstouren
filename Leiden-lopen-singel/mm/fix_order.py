...
for filename in html_files:
    ...
    # Haal ALLEEN de verdachten-grid WEG
...
<head>
    ...
    <style>
        ...
        /* Zorg dat de globale grid onder de pagina-inhoud komt */
...
print("Fixed order: top-row -> page content -> global verdachten-grid -> nav-buttons")
