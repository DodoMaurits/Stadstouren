...
<head>
    ...
    <style>
        ...
        /* Zorg dat de globale verdachten-grid altijd zichtbaar is */
...
# Voeg alle pagina's toe (met nav-buttons, zonder verdachten-grid)
...
html_output += '''        
        <!-- Globale verdachten-grid (altijd zichtbaar, onder de pagina-inhoud) -->
...
html_output += '''            ];
            ...
            document.addEventListener('click', (e) => {
                ...
                // Check if it's a local page navigation
...
print("Final build: Inhoud + nav-buttons in pagina's, globale verdachten-grid onder inhoud")
