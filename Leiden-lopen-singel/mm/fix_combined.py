...
for filename in html_files:
    ...
    # Haal ALLEEN de verdachten-grid WEG, maar LAAT nav-buttons zitten!
...
<head>
    ...
    <style>
        ...
        /* Verberg de verdachten-grid in de pagina's zelf (we hebben een globale) */
...
print("Fixed combined HTML - nav-buttons in pages, global verdachten-grid")
