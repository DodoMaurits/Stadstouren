...
for filename in html_files:
    ...
    # Haal ZOWEL verdachten-grid ALS nav-buttons WEG
...
for idx, filename in enumerate(page_order):
    if filename in pages_data:
        ...
        # Sla de nav_buttons op in een data-attribute
        nav_html = data.get('nav_buttons', '')
        if nav_html:
            # Escape voor HTML attribute
...
print("Final fix: globale nav-buttons onder verdachten-grid")
